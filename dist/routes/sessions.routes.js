...
sessionsRouter.post('/', function (request, response) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, user_email, user_password, authenticateUser, _b, user, token, err_1;
    return __generator(this, function (_c) {
        switch (_c.label) {
            case 0:
                _c.trys.push([0, 2, , 3]);
                _a = request.body, user_email = _a.user_email, user_password = _a.user_password;
                authenticateUser = new AuthenticateUserServices_1.default();
