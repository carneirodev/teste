...
var CreateUserService = /** @class */ (function () {
    ...
    CreateUserService.prototype.execute = function (_a) {
        var room_name = _a.room_name, user_id = _a.user_id;
        return __awaiter(this, void 0, void 0, function () {
            var usersRepository, roomRepository, user, room;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        usersRepository = typeorm_1.getRepository(User_1.default);
                        roomRepository = typeorm_1.getRepository(Rooms_1.default);
                    ...
                    case 2:
                        _b.sent();
                        return [4 /*yield*/, usersRepository.update(user_id, {
